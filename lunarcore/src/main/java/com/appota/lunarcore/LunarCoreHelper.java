...
public class LunarCoreHelper {
    ...
    public static String TAG123="LunarCoreHelper";
    /**
     *
     * @param dd
     * @param mm
...
//			arc = INT(getSunLongitude(getNewMoonDay(k + i, timeZone), timeZone));
    ...
    public static int[] convertSolar2Lunar(int dd, int mm, int yy,
        ...
        if (b11 - a11 > 365) {
            ...
            Log.d(TAG123,"xxxxxxxxxxxx- leapMonthDeff = "+leapMonthDiff);
    ...
    public static int[] convertLunar2Solar(int lunarDay, int lunarMonth,
        ...
        if (b11 - a11 > 365) {
            ...
            Log.d(TAG123,"xxxxxxxxxxxxxxxxxxxx-leapMonth ="+leapMonth);
            if (leapMonth < 0) {
                leapMonth += 12;
            }
        ...
        Log.d(TAG123,"xxxxxxxxx - monthStart ="+monthStart);
